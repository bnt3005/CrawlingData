...
MailSenderService mailService = new MailSenderService();
in.crawlingEmail = mailService.buildEmailObject();' #txt
...
' #txt
sa0 f9 504 42 112 44 -25 -8 #rect
...
' #txt
sa0 f12 664 42 112 44 -32 -8 #rect
sa0 f12 @|EMailIcon #fIcon
sa0 f13 expr out #txt
sa0 f13 616 64 664 64 #arcP
sa0 f2 expr out #txt
sa0 f2 776 64 841 64 #arcP
sa0 f10 expr in #txt
...
' #txt
sa0 f3 344 42 112 44 -38 -8 #rect
...
' #txt
sa0 f7 428 220 841 69 #arcP
sa0 f7 0 0.4437803002277993 -3 -11 #arcLabel
sa0 f11 expr out #txt
sa0 f11 456 64 504 64 #arcP
sa0 f4 expr out #txt
sa0 f4 111 64 344 64 #arcP
sa0 f4 0 0.5000000000000001 0 0 #arcLabel
